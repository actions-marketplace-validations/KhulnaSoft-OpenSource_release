...
!GIT_COMMITTER_NAME && (process.env.GIT_COMMITTER_NAME = "khulnasoft-opensource[bot]");
!GIT_COMMITTER_EMAIL && (process.env.GIT_COMMITTER_EMAIL = "63161813+khulnasoft-opensource[bot]@users.noreply.github.com");
